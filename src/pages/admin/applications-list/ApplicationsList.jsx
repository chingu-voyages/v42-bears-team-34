import { styled, Paper, Table, TableContainer, TableCell, TableHead, TableBody, TableRow } from "@mui/material";
...
export function ApplicationsList (props) {
  ...
  return (
    <CustomStyledTableContainer component={Paper}>
      <Table sx={{ backgroundColor: PALLET.applicationDetails.backgroundColor}} aria-label="applications table">
        <TableHead>
          <TableRow>
            <StyledTableHeaderCell>Status</StyledTableHeaderCell>
            <StyledTableHeaderCell>Name</StyledTableHeaderCell>
            <StyledTableHeaderCell>{FIELD_DICT[SIGNUP_FIELDS.applicantGender]}</StyledTableHeaderCell>
            <StyledTableHeaderCell>{FIELD_DICT[SIGNUP_FIELDS.city]}</StyledTableHeaderCell>
            <StyledTableHeaderCell>{FIELD_DICT[SIGNUP_FIELDS.province]}</StyledTableHeaderCell>
            <StyledTableHeaderCell>{FIELD_DICT[SIGNUP_FIELDS.requestedLoanAmount]} </StyledTableHeaderCell>
            <StyledTableHeaderCell>{FIELD_DICT[SIGNUP_FIELDS.applicantIncome]}</StyledTableHeaderCell>
          </TableRow>
        </TableHead>
        <TableBody>
