...
const VALIDATION_RULES = [
  ...
  },
  {
    ...
    validationMessage: "Password should be at least 8 characters and contain a number and a special character",
  },
  {
...
export class SignupValidator {
  ...
  static validate(fields, input) {
    ...
    for (const fieldName of fields) {
      ...
      const matchingRules = SignupValidator.#getMatchingRules(VALIDATION_RULES, fieldName);
      let matchingErrors = {};
      matchingErrors = SignupValidator.#getValidationErrors(matchingRules, input);
      allErrors = {
        ...allErrors,
        ...matchingErrors
      }
