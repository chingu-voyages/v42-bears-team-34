  ...
  return (
    <div>
      <Box mt={3} mb={3}>
        ...
        />
        {props.errors && props.errors[SIGNUP_FIELDS.firstName] && (
          <ErrorComponent title={props.errors[SIGNUP_FIELDS.firstName]} />
        )}
      </Box>
      <Box mb={3}>
        <TextField
        ...
        {props.errors && props.errors.lastName && (
          <ErrorComponent title={props.errors.lastName} />
        )}
      </Box>
      <Box mb={3}>
        <TextField
          ...
          InputProps={{ maxLength: 50 }}
        />
        {props.errors && props.errors[SIGNUP_FIELDS.streetAddress] && (
          <ErrorComponent title={props.errors[SIGNUP_FIELDS.streetAddress]} />
        )}
      </Box>
      <Box mb={3}>
        <TextField
          ...
          onChange={handleChange}
        />
        {props.errors && props.errors[SIGNUP_FIELDS.unitNumber] && (
          <ErrorComponent title={props.errors[SIGNUP_FIELDS.unitNumber]} />
        )}
      </Box>
      <Box mb={3}>
        <TextField
          ...
          onChange={handleChange}
        />
        {props.errors && props.errors[SIGNUP_FIELDS.additionalAddress] && (
          <ErrorComponent
            title={props.errors[SIGNUP_FIELDS.additionalAddress]}
          />
        )}
      </Box>
      <Box mb={3}>
        ...
        />
        {props.errors && props.errors.city && (
          <ErrorComponent title={props.errors.city} />
        )}
      </Box>
      <Box mb={3}>
        <FormControl
        ...
        >
          <InputLabel shrink={true} id="province-label">
            Select province
          </InputLabel>
          <Select
          ...
          {props.errors && props.errors[SIGNUP_FIELDS.province] && (
            <ErrorComponent title={props.errors[SIGNUP_FIELDS.province]} />
          )}
        </FormControl>
      </Box>
      <Box mb={3}>
        <TextField
          ...
          color="secondary"
        />
        {props.errors && props.errors[SIGNUP_FIELDS.postalCode] && (
          <ErrorComponent title={props.errors[SIGNUP_FIELDS.postalCode]} />
        )}
      </Box>
      <Box mb={3}>
        <InputMask
          mask="999-999-9999"
          onChange={handleChange}
          value={inputs[SIGNUP_FIELDS.phone]}
        >
          <TextField
            sx={{ width: 200 }}
            type="tel"
        ...
        {props.errors && props.errors[SIGNUP_FIELDS.phone] && (
          <ErrorComponent title={props.errors[SIGNUP_FIELDS.phone]} />
        )}
      </Box>
    </div>
  );
