 ...
 */
export function generateSignupError(
  error,
  setModalOpenFunction,
  setTitleFunction
) {
  ...
  switch (parsedError) {
    case SIGNUP_FLOW_RESULT_STATUS.emailExists:
      setTitleFunction({
        title: 'Error',
        bodyText:
          'Please log into the user portal with your e-mail and credentials to continue this process.',
      });
    ...
    case SIGNUP_FLOW_RESULT_STATUS.invalidUsernamePassword:
      setTitleFunction({
        title: 'Error',
        bodyText:
          'There was a problem with your credentials. Please use the user portal to sign-in or recover your credentials.',
      });
      setModalOpenFunction(true);
      break;
    case SIGNUP_FLOW_RESULT_STATUS.pendingApplicationExists:
      setTitleFunction({
        title: 'Error',
        bodyText:
          'There is already an application pending review associated with your profile. Please use the user portal to view the status of your application.',
      });
      setModalOpenFunction(true);
      break;
    default:
