...
function AccountsContainerComponent (props) {
  ...
  return (
    <Box mt={2}>
      ...
      <AccountsAccordion accountsArray={accounts} summaryTitle={"Accounts"} summaryTitleStyles={{ fontWeight: "bold"}} summarySubText={accounts && accounts.length ? `(${accounts.length}) found` : ""} />
    </Box>
  )
}
