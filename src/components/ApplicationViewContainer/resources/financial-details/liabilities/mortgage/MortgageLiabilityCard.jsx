...
function MortgageLiabilityCard (props) {
  const { account_id, account_number, origination_principal_amount, next_monthly_payment, loan_term, property_address, ytd_principal_paid, interest_rate } = props;
  const extractedData = {
    account_id,
    account_number,
    ...
    loan_term,
    property_address: { type: ConversionType.fromObject, data: property_address }, // this is an object
