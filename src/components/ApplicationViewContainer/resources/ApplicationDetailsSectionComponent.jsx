	...
	return (
		<Box>
			...
			>
				<Grid item>
					<StyledGridItem
						headerText={FIELD_DICT[SIGNUP_FIELDS.applicantIncome]}
						subText={STRING_HELPERS.formatToCurrency(applicantIncome)}
					/>
				</Grid>
				<Grid item>
					<StyledGridItem
						headerText={FIELD_DICT[SIGNUP_FIELDS.requestedLoanAmount]}
						subText={STRING_HELPERS.formatToCurrency(requestedLoanAmount)}
					/>
				</Grid>
				<StyledGridItem
					headerText={FIELD_DICT[SIGNUP_FIELDS.installmentAmount]}
					subText={STRING_HELPERS.formatToCurrency(installmentAmount)}
				/>
				<Grid item></Grid>
				<Grid item>
					<StyledGridItem
						headerText={FIELD_DICT[SIGNUP_FIELDS.numberOfInstallments]}
						subText={numberOfInstallments}
					/>
				</Grid>
				<Grid item>
					<StyledGridItem
						headerText={FIELD_DICT[SIGNUP_FIELDS.loanPurpose]}
						subText={STRING_HELPERS.capitalizeFirstLetter(loanPurpose)}
					/>
				</Grid>
				<Grid item>
					<StyledGridItem
						headerText={FIELD_DICT['updatedAt']}
						subText={STRING_HELPERS.formatDate(updatedAt)}
					/>
				</Grid>
				<Grid item>
					<StyledGridItem
						headerText={'Date of Application'}
						subText={STRING_HELPERS.formatDate(requestedAt)}
					/>
				</Grid>
			</StyledGridContainer>
			<Box>
        ...
        */}
				...
				{status != 'rejected' && (
					...
					>
						{FIELD_DICT.applicationStatus[status].toUpperCase()}
					</Typography>
				)}
				{statusMessage && (
